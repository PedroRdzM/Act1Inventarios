...
<head>
    ...
    <meta name="description" content="Act 1 Sistema de Ventas e Inventario">
    <meta name="keyword" content="Sistema Inventrario y ventas">
    <title>Act1.-Sistema Inventario y ventas</title>
    <!-- Icons -->
...
<header class="app-header navbar">
  ...
  <script src="{{asset('js/jquery.min.js')}}"></script>
    ...
    <script>
        ...
        //llamamos los datos del index.blade
        ...
        //encuentra em modal-body el nombre,desc y id  y los carga 
        ...
        var id_categoria = button.data('id_categoria')
        var modal = $(this)
        //encuentra y carga el id de la categoria
        
        modal.find('.modal-body #id_categoria').val(id_categoria);
        })
         
        /*FIN  para cambiar estado de la categoria*/

 /*EDITAR PRODUCTO EN VENTANA */
         $('#abrirmodalEditar').on('show.bs.modal', function (event) {
        
        /*el button.data es lo que está en el button de editar*/
        var button = $(event.relatedTarget)
        /*id_categoria_modal_editar selecciona la categoria*/
        ...
        /*FIN para cambiar estado del producto*/
